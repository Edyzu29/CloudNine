...
void __attribute__((picinterrupt(("high_priority")))) Timer(void) {
...
void __attribute__((picinterrupt(("low_priority")))) Adc(void) {
    if (PIR1bits.ADIF == 1) {
        PIR1bits.ADIF = 0;
