...
void main (void){
   ...
   T1CONbits.TMR1ON=0;
    ...
    while (1) {
            ...
            PORTDbits.RD7= 0; _delay((unsigned long)((10)*(20000000UL/4000000.0)));
            PORTDbits.RD7= 1; _delay((unsigned long)((10)*(20000000UL/4000000.0)));
            PORTDbits.RD7= 0;


            while(PORTDbits.RD6 == 0); TMR1 = 0;
            T1CONbits.TMR1ON=1;

            while(PORTDbits.RD6 == 1 ); a = TMR1;
            T1CONbits.TMR1ON=0;
