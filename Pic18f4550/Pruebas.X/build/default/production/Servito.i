...
void Giro_Servo(char selec,int SelecDeServo){
    switch(selec){
        case '0':
            ...
            SelecDeServo=0;
            SelecDeServo=1;
            _delay((unsigned long)((0.5)*(8000000UL/4000.0)));
            SelecDeServo=0;
            _delay((unsigned long)((20-0.5)*(8000000UL/4000.0)));}
            break;
        case '90':
            for(int i=0;i<16;i++){
            SelecDeServo=0;
...
void Servo_Posicion_Inicial (void){
    Giro_Servo('0',LATBbits.LATB0);
    Giro_Servo('0',LATBbits.LATB1);
    Giro_Servo('0',LATBbits.LATB2);
    Giro_Servo('0',LATBbits.LATB3);
    Giro_Servo('0',LATBbits.LATB4);
    Giro_Servo('0',LATBbits.LATB5);
    Giro_Servo('0',LATBbits.LATB6);
}
