...
# 2 "../Integrador.X/MiLCD.c" 2

# 1 "../Integrador.X/MiLCD.h" 1
# 37 "../Integrador.X/MiLCD.h"
...
void LCD_Linea4( void )
{
 LCD_EnviaComando(0x80 + 0x40 + 40/2);
}
...
{
    LCD_EnviaComando(0x80 + 0x00 + 40/2 + Pos);
}
...
{
    LCD_EnviaComando(0x80 + 0x40 + 40/2 + Pos);
}
...
{
    PORTCbits.RC2 = 1;
    Caracter = LCD_CodigoCGROM( Caracter );
    LCD_Envia( Caracter );
}
...
{
    uint8_t LCD_GuardaTRIS = (TRISBbits.TRISB7 << 7) |
                             (TRISBbits.TRISB6 << 6) |
                             (TRISBbits.TRISB5 << 5) |
                             (TRISBbits.TRISB4 << 4) |
                             (TRISBbits.TRISB3 << 3) |
    ...
    PORTCbits.RC0 = 0;
    LCD_CfgPort( LCD_GuardaTRIS );

    if( !PORTCbits.RC2 ) _delay((unsigned long)((20)*(4000000UL/4000.0)));
    _delay((unsigned long)((50)*(4000000UL/4000000.0)));
}
# 298 "../Integrador.X/MiLCD.c"
uint8_t LCD_CodigoCGROM( uint8_t Caracter )
{
    if( Caracter == 'ñ' ) return 0B11101110;
    if( Caracter == 'Ñ' ) return 0B11101110;
    if( Caracter == '°' ) return 0B11011111;
    return Caracter;
}
...
{
    PORTBbits.RB7 = (Dato & 0x80) ? 1 : 0;
    PORTBbits.RB6 = (Dato & 0x40) ? 1 : 0;
    PORTBbits.RB5 = (Dato & 0x20) ? 1 : 0;
    PORTBbits.RB4 = (Dato & 0x10) ? 1 : 0;
    PORTBbits.RB3 = (Dato & 0x08) ? 1 : 0;
    PORTBbits.RB2 = (Dato & 0x04) ? 1 : 0;
    PORTBbits.RB1 = (Dato & 0x02) ? 1 : 0;
    PORTBbits.RB0 = (Dato & 0x01) ? 1 : 0;
}
...
{
    TRISBbits.TRISB7 = (Cfg & 0x80) ? 1 : 0;
    TRISBbits.TRISB6 = (Cfg & 0x40) ? 1 : 0;
    TRISBbits.TRISB5 = (Cfg & 0x20) ? 1 : 0;
    TRISBbits.TRISB4 = (Cfg & 0x10) ? 1 : 0;
    TRISBbits.TRISB3 = (Cfg & 0x08) ? 1 : 0;
    TRISBbits.TRISB2 = (Cfg & 0x04) ? 1 : 0;
    TRISBbits.TRISB1 = (Cfg & 0x02) ? 1 : 0;
