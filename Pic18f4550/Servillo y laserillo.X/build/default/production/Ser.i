...
void Confi_Servo(void){
 ...
 void Servo_Fake_0 (void){
            ...
            LATBbits.LATB0=0;
            LATBbits.LATB0=1;
            _delay((unsigned long)((0.5)*(20000000/4000.0)));
            LATBbits.LATB0=0;
            _delay((unsigned long)((20-0.5)*(20000000/4000.0)));}
    }
  ...
  void Servo_Fake_45 (void){
            ...
            LATBbits.LATB0=0;
            LATBbits.LATB0=1;
            _delay((unsigned long)((1.0)*(20000000/4000.0)));
            LATBbits.LATB0=0;
            _delay((unsigned long)((20-1.0)*(20000000/4000.0)));}
    }
...
void Servo_Fake_90 ( void){
            ...
            LATBbits.LATB0=0;
            LATBbits.LATB0=1;
            _delay((unsigned long)((1.5)*(20000000/4000.0)));
            LATBbits.LATB0=0;
            _delay((unsigned long)((20-1.5)*(20000000/4000.0)));}
}
...
void Servo_Fake_135 (void){
            ...
            LATBbits.LATB0=0;
            LATBbits.LATB0=1;
            _delay((unsigned long)((2.0)*(20000000/4000.0)));
            LATBbits.LATB0=0;
            _delay((unsigned long)((20-2.0)*(20000000/4000.0)));}
}
...
void Servo_Fake_180 (void){
    for(int i=0;i<16;i++){
            LATBbits.LATB0=0;
            LATBbits.LATB0=1;
            _delay((unsigned long)((2.5)*(20000000/4000.0)));
            LATBbits.LATB0=0;
            _delay((unsigned long)((20-2.5)*(20000000/4000.0)));}
}
